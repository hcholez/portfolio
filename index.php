  ...
  <div id="me" class="wrapper">
    <div class="container">
      ...
      <div class="row bubble-right">
        <div class="col-md-2 col-md-offset-5 col-xs-3 bubble">
      ...
      <div class="row bubble-left">
        ...
        <div class="col-md-2 col-xs-3 bubble">
          <span class=item></span><br>
      ...
      <?php if ($dossier = opendir('images/creations')) : ?>
        <?php while(false !== ($fichier = readdir($dossier))) : ?>
          <?php if($fichier != '.' && $fichier != '..' && $fichier != 'index.php' && $fichier != '.DS_Store') : ?>
            <div class="article">
              <div class="image">
                <a href="images/creations/<?php echo $fichier ?>"  data-lightbox="roadtrip">
                  <img src="<?php echo "images/creations/" .$fichier ?>" alt="<?php echo $fichier ?>" />
                </a>
              </div>
            </div>
          <?php endif; ?>
